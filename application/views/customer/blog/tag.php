		...
		<div class="blog_preview_body_padding">
			...
			foreach ($blogs as $b){
				...
				<div class="white_bg_transparent blog_preview">
					<div class="title1">
						<?php echo Blog_parser::pure_text($b['title'], $b['blog_id']);?>
					</div>
					<div class="blog_preview_body">
						<div>
							<?php echo word_limiter(Blog_parser::pure_text(read_file("./content/blog/".$b['blog_id']."/bodyTextarea.txt"), $b['blog_id']), 50)?>
