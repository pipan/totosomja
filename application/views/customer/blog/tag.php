		...
		<div class="blog_preview_body_padding">
			...
			foreach ($blogs as $b){
				...
				<div class="white_bg_transparent blog_preview">
					<div class="title1">
						<?php echo Blog_parser::pure_text($b['title'.$language_ext], $b['blog_id'], $language_ext);?>
					</div>
					<div class="blog_preview_body">
						...
						echo word_limiter(Blog_parser::pure_text(read_file("./content/blog/".$b['blog_id']."/bodyTextarea".$language_ext.".txt"), $b['blog_id'], $language_ext, true), 50)?>
