		...
		<?php 
			...
			?>
				...
				<div>
					...
					<textarea id="product_description_en" name="description_en"><?php echo set_value('description_en', read_file("./content/product/description/".$product['id']."_en.txt"));?></textarea>
				</div>
				<div>
