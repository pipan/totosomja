						...
						<div class="outer-center">
							<div class="inner-center">
								<div class="header_navigator_item">
									<a href="<?php echo base_url()."index.php/admin/manager";?>">cms</a>
								</div>
								<div class="header_navigator_item">
									<a href="<?php echo base_url()."index.php/admin/system/database";?>">database</a>
								</div>
								<div class="header_navigator_item">
									<a href="<?php echo base_url()."index.php/admin/system/paypal";?>">paypal</a>
								</div>
								<div class="header_navigator_item">
									<a href="">log</a>
								</div>
